...
- **Audio scope:** persisted global mute (default unmuted) + transient playing indicator; no volume level (API is mute-only — parked in 0013); content-gated toolbar chrome (no URL / floating → no audio controls, 0004:2/0006:11).
